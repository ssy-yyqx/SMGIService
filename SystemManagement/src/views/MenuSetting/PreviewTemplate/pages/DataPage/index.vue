<template>
  <Paper :title="title">
    <div slot="opera">
      ...
      <span class="opera-item" @click="gotoOnlineHandling">在线办理</span>
    ...
    <div slot="content">
      <Introduce v-if="activeTab === 'introduce'" />
      <HandlingGuide v-if="activeTab === 'handlingGuide'" />
...
export default {
  ...
  methods: {
    ...
    gotoOnlineHandling() {
      ...
      const { specialRouter } = this.$route.meta
      if (specialRouter) {
