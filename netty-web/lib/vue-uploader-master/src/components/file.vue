  ...
  export default {
    ...
    computed: {
      ...
      status () {
        ...
        const waitForMd5 = this.file.waitForMd5
        if (isComplete) {
          return 'success'
        } else if (isError) {
          return 'error'
    ...
    methods: {
      _actionCheck () {
        ...
        this.waitForMd5 = this.file.waitForMd5
...
<style>
  ...
  .uploader-file[status="waitForMd5"] .uploader-file-resume {
		display: none;
  }
