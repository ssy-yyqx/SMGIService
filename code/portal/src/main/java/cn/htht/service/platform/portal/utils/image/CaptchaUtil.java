package cn.htht.service.platform.portal.utils.image;


import cn.htht.service.platform.portal.utils.encrypt.Base64Ext;
import cn.htht.service.platform.portal.utils.image.gif.GifEncoder;
...
public final class CaptchaUtil {
    ...
    public static boolean pngCaptcha(String randomStr, int width, int height, String file) {
        ...
        try (OutputStream out = new FileOutputStream(file)) {
            generateImages(width, height, strs, out);
            out.flush();
            return true;
        } catch (IOException e) {
            return false;
    ...
    public static boolean gifCaptcha(String randomStr, int width, int height, String file) {
        ...
        try (OutputStream out = new FileOutputStream(file)) {
            ...
            generateGif(out, len, width, height, rands);
            return true;
    ...
    private static void generateGif(OutputStream out, int len, int width, int height, char[] rands) {
    ...
    private static void generateImages(int width, int height, char[] strs, OutputStream out) throws IOException {
