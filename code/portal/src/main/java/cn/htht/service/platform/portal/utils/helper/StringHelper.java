...
import cn.htht.service.platform.portal.utils.utils.BCConvertUtil;
...
public class StringHelper {
    ...
    public static String full2Half(String str) {
        ...
        return BCConvertUtil.qj2bj(str);
    }
    ...
    public static String Half2Full(String str) {
        ...
        return BCConvertUtil.bj2qj(str);
    }
    ...
    public static String replaceBlank(String str) {
        if (str != null) {
            Matcher m = RegConstant.PATTER_BLANK_CODE.matcher(str);
            str = m.replaceAll("");
        }
        return str;
    }
    ...
    public static String str2HexStr(String str) {
        ...
        for (int i = 0; i < bs.length; i++) {
            bit = (bs[i] & 0x0f0) >> 4;
            sb.append(BaseConstant.HEX_CHAR[bit]);
            bit = bs[i] & 0x0f;
            sb.append(BaseConstant.HEX_CHAR[bit]);
            // sb.append(' ');
        }
    ...
    public static String hexStr2Str(String hexStr) {
        String str = BaseConstant.HEX_CHAR_STR;
