...
public class DbSearcher {
     ...
     * @throws FileNotFoundException
     */
    public DbSearcher(DbConfig dbConfig) throws FileNotFoundException {
        this.dbConfig = dbConfig;
        String dbFile = this.getClass().getClassLoader().getResource("").getPath() + File.separator + "ipdata" + File.separator + "ip2region.db";
        raf = new RandomAccessFile(dbFile, "r");
    }
