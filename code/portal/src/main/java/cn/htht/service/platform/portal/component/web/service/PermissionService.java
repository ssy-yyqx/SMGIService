...
/**
 * Htht首创 自定义权限实现，ss取自SpringSecurity首字母
 *
 * @author htht
 */
@Service("ss")
public class PermissionService {
    ...
    public boolean hasRole(String role) {
        ...
        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
        if (StringUtils.isNull(loginUser) || CollectionUtils.isEmpty(loginUser.getUser().getRoleList())) {
            return false;
        }
        for (SystemRole sysRole : loginUser.getUser().getRoleList()) {
