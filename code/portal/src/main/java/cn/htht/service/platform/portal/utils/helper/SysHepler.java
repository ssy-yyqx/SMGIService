...
import cn.htht.service.platform.portal.constant.BaseConstant;
import cn.htht.service.platform.portal.utils.utils.CheckUtil;
import cn.htht.service.platform.portal.utils.utils.PropertiesUtil;
...
public class SysHepler {
     ...
     * JVM的版本
     */
    public static final String JVM_VERSION = PropertiesUtil.key(BaseConstant.JVM_VERSION);
    /**
     * JVM的编码
     */
    public static final String JVM_ENCODING = PropertiesUtil.key(BaseConstant.JVM_ENCODING);
    /**
     * JVM默认的临时目录
     */
    public static final String JVM_TEMPDIR = PropertiesUtil.key(BaseConstant.JVM_TEMPDIR);
     ...
     * 主机架构
     */
    public static String OS_ARCH = PropertiesUtil.key(BaseConstant.SYS_OS_ARCH);
    /**
     * 主机类型
     */
    public static String OS_NAME = PropertiesUtil.key(BaseConstant.SYS_OS_NAME);
    /**
     * 主机类型版本
     */
    public static String OS_VERSION = PropertiesUtil.key(BaseConstant.SYS_OS_VERSION);
    /**
     * 操作系统类型
     */
    public static String SUN_DESKTOP = PropertiesUtil.key(BaseConstant.SYS_SUN_DESKTOP);


    public static String FILE_SEPARATOR = PropertiesUtil.key(BaseConstant.SYS_FILE_SEPARATOR);
    public static String PATH_SEPARATOR = PropertiesUtil.key(BaseConstant.SYS_PATH_SEPARATOR);
    public static String LINE_SEPARATOR = PropertiesUtil.key(BaseConstant.SYS_LINE_SEPARATOR);
    /**
     * 总的物理内存
     */
    ...
    public final static void setHttpProxy(String host, String port, String username, String password) {
        System.getProperties().put(BaseConstant.HTTP_PROXY_HOST, host);
        System.getProperties().put(BaseConstant.HTTP_PROXY_PORT, port);
        System.getProperties().put(BaseConstant.HTTP_PROXY_USER, username);
        System.getProperties().put(BaseConstant.HTTP_PROXY_PASSWORD, password);
    }
