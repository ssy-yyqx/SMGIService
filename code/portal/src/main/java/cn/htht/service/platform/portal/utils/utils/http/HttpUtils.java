package cn.htht.service.platform.portal.utils.utils.http;
...
public class HttpUtils {
    ...
    public static String sendGet(String url, String param, Map<String, String> headerMap) {
        ...
        try {
            ...
            connection.connect();
            in = new BufferedReader(new InputStreamReader(connection.getInputStream(), headerMap.get("Content-Type")));
            String line;
            while ((line = in.readLine()) != null) {
                result.append(line);
            }
