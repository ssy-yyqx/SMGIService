...
import cn.htht.service.platform.portal.utils.encrypt.URIPart;
...
public final class UrlHelper {
    ...
    public static String encodeScheme(String scheme) {
        return encodeUriComponent(scheme, BaseConstant.UTF_8, URIPart.SCHEME);
    }
...
*/
    ...
    public static String encodeUserInfo(String userInfo) {
        return encodeUriComponent(userInfo, BaseConstant.UTF_8, URIPart.USER_INFO);
    }
    ...
    public static String encodeHost(String host) {
        return encodeUriComponent(host, BaseConstant.UTF_8, URIPart.HOST);
    }
    ...
    public static String encodePort(String port) {
        return encodeUriComponent(port, BaseConstant.UTF_8, URIPart.PORT);
    }
    ...
    public static String encodePath(String path) {
        return encodeUriComponent(path, BaseConstant.UTF_8, URIPart.PATH);
    }
    ...
    public static String encodePathSegment(String segment) {
        return encodeUriComponent(segment, BaseConstant.UTF_8, URIPart.PATH_SEGMENT);
    }
    ...
    public static String encodeQuery(String query) {
        return encodeUriComponent(query, BaseConstant.UTF_8, URIPart.QUERY);
    }
    ...
    public static String encodeQueryParam(String queryParam) {
        return encodeUriComponent(queryParam, BaseConstant.UTF_8, URIPart.QUERY_PARAM);
    }
    ...
    public static String encodeFragment(String fragment) {
        return encodeUriComponent(fragment, BaseConstant.UTF_8, URIPart.FRAGMENT);
    }
    ...
    public static String encode(String uri) {
        return encode(uri, BaseConstant.UTF_8);
    }
    ...
    public static String encode(String uri, String encoding) {
        Matcher m = RegConstant.URI_PATTERN.matcher(uri);
        if (m.matches()) {
    ...
    public static String encodeHttpUrl(String httpUrl) {
        return encodeHttpUrl(httpUrl, BaseConstant.UTF_8);
    }
    ...
    public static String encodeHttpUrl(String httpUrl, String encoding) {
        Matcher m = RegConstant.HTTP_URL_PATTERN.matcher(httpUrl);
        if (m.matches()) {
    ...
    public static Builder build(String path, boolean encodePath) {
        return new Builder(path, encodePath, BaseConstant.UTF_8);
    }
    ...
    public static String decode(String url) {
        return decode(url, BaseConstant.UTF_8, false);
    }
    ...
    public static String decodeQuery(String source) {
        return decode(source, BaseConstant.UTF_8, true);
    }
