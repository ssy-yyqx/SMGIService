...
public final class HttpHelper {
    ...
    static class SSLmiTM implements javax.net.ssl.TrustManager, javax.net.ssl.X509TrustManager {
        @Override
    ...
    public static String sendGet(String httpurl) {
        ...
        try {
            ...
            if (connection.getResponseCode() == 200) {
                ...
                // 封装输入流is，并指定字符集
                br = new BufferedReader(new InputStreamReader(is, BaseConstant.UTF_8));
                // 存放数据
