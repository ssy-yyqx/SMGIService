...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 扫描指定包中的swagger注解
                // .apis(RequestHandlerSelectors.basePackage("cn.htht.project.tool.swagger"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                // 设置标题
                .title("标题：" + config.getName() + "_接口文档")
                // 描述
                .description("描述：" + config.getName() + "_接口文档")
                // 作者信息
